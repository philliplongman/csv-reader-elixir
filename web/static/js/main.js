...
var _user$project$Encoders$encodeFile = function (file) {
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'name',
				_1: _elm_lang$core$Json_Encode$string(file.name)
			},
			_1: {
				ctor: '::',
				_0: {
...
var _user$project$Msg$FileParsed = function (a) {
	return {ctor: 'FileParsed', _0: a};
};
...
var _user$project$Update$uploadFile = function (file) {
	var decoder = _user$project$Decoders$decodePeople;
	var body = _elm_lang$http$Http$jsonBody(
		_user$project$Encoders$encodeFile(file));
	var request = A3(_elm_lang$http$Http$post, '/api/upload', body, decoder);
	return A2(_elm_lang$http$Http$send, _user$project$Msg$FileParsed, request);
};
			...
			case 'FileRead':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							filename: _elm_lang$core$Maybe$Just(_p1.name)
						}),
					_1: _user$project$Update$uploadFile(_p1)
				};
			case 'FileParsed':
				if (_p0._0.ctor === 'Ok') {
					return {
...
var _user$project$View_Count$countView = function (_p0) {
	...
	var count = A3(
		...
		'person',
		'people',
		_elm_lang$core$List$length(_p1.people));
	return A2(
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Import a file'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$name('file'),
												_1: {
													ctor: '::',
